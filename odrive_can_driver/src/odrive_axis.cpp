...
{
  motor_axis_->position_state = motor_axis_->position_state.load() * position_factor_;
  motor_axis_->velocity_state = motor_axis_->velocity_state.load() * position_factor_;
  motor_axis_->effort_state = motor_axis_->effort_state.load() * torque_factor_;
  motor_axis_->timeout_error = motor_axis_->timeout_error.load();
  motor_axis_->error = motor_axis_->error.load();
}
